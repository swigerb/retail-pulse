...
| --- | --- | --- | --- |
| Kroger | Lead | review | .NET architecture, Aspire orchestration, system design, code review, tenant configuration |
| Chick | Frontend Dev | edit | React, Vite, TypeScript, modern UI/UX, component architecture, dashboard design |
| Costco | Backend Dev | edit | .NET 10, C# APIs, Azure API Management, AI Gateway pattern, service architecture, tenant services |
| Publix | Tester | review, edit | .NET testing (xUnit), React testing (Vitest/Testing Library), integration tests, edge cases, tenant… |

### Supported task types

Lead, Frontend Dev, Backend Dev, Tester
...
- **Can:** review code and pull requests; write and modify code; write and run tests; author and maintain CI/CD workflows; UX and visual design
- **Cannot (no agent claims this):** write and maintain documentation; security and secrets review; responsible-AI and content-safety review; cut releases and publish packages; deploy to live environments
