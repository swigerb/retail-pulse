...
const mockBrands: BrandScore[] = [
  {
    ...
    healthScore: 82,
    trend: 'up',
    dimensions: { demand: 85, margin: 78, competitive: 90, supply: 76 },
  ...
  },
  {
    ...
    healthScore: 45,
    trend: 'down',
    dimensions: { demand: 50, margin: 40, competitive: 42, supply: 48 },
  ...
  },
  {
    ...
    healthScore: 65,
    trend: 'stable',
    dimensions: { demand: 70, margin: 60, competitive: 65, supply: 65 },
