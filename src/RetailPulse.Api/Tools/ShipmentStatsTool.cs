...
public class ShipmentStatsTool
{
    ...
    [Description("Get shipment statistics (sell-in from Bacardi to distributors) for a brand in a specific region. Returns shipment volumes, sell-through correlation, inventory levels, and pipeline anomaly detection (e.g., pipeline clogs where shipments outpace consumer demand).")]
