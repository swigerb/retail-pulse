...
public static class CompetitiveTools
{
    ...
    public static object GetCompetitorPricing(
        ...
        [Description("Comma-separated competitor names (e.g. 'Jack Daniel\\'s,Patrón'). Omit for all.")] string? competitors = null)
    {
        return data.GetCompetitorPricing(brand, category, region, competitors);
    }
    ...
    public static object GetMarketShare(
        ...
        [Description("Period to filter (e.g. '2026-Q1', '2025-Q4'). Omit for all periods.")] string? period = null)
    {
        return data.GetMarketShare(brand, category, region, period);
    }
    ...
    {
        return data.DetectCompetitiveThreats(brand, category, region);
    }
