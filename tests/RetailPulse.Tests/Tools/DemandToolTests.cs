...
public class DemandToolTests : IDisposable
{
    ...
    {
        JsonElement result = Parse(_db.GetHistoricalDemand(brand, region));
    ...
    {
        JsonElement result = Parse(_db.GetHistoricalDemand("Sierra Gold Tequila"));

        result.TryGetProperty("error", out _).Should().BeFalse();
        JsonElement weeklyData = result.GetProperty("weekly_data");
    ...
    {
        JsonElement result = Parse(_db.GetHistoricalDemand("Sierra Gold Tequila", "Northeast"));
    ...
    {
        JsonElement result = Parse(_db.GetHistoricalDemand("Sierra Gold Tequila", null, "On-Premise"));
    ...
    {
        JsonElement result = Parse(_db.GetHistoricalDemand("Totally Fake Brand XYZ"));
    ...
    {
        JsonElement result = Parse(_db.GetHistoricalDemand(null));
    ...
    {
        JsonElement result = Parse(_db.GetHistoricalDemand("Sierra Gold Tequila", months: 3));
    ...
    {
        JsonElement result = Parse(_db.GenerateForecast("Sierra Gold Tequila"));
    ...
    {
        JsonElement result = Parse(_db.GenerateForecast("Sierra Gold Tequila", days: 30));
    ...
    public void GenerateForecast_ConfidenceBoundsAreReasonable()
    {
        ...
        result.TryGetProperty("error", out _).Should().BeFalse();
        JsonElement forecasts = result.GetProperty("forecast");

        foreach (JsonElement day in forecasts.EnumerateArray().Take(10))
        {
            double predicted = day.GetProperty("predicted_volume").GetDouble();
            double lower = day.GetProperty("confidence_lower").GetDouble();
            double upper = day.GetProperty("confidence_upper").GetDouble();
    ...
    public void GenerateForecast_SeasonalMultipliersApplied()
    {
        ...
        JsonElement algorithm = result.GetProperty("algorithm");
    ...
    {
        JsonElement result = Parse(_db.GenerateForecast(""));
    ...
    {
        JsonElement result = Parse(_db.GenerateForecast("Totally Nonexistent Brand"));
    ...
    {
        JsonElement result = Parse(_db.GenerateForecast("Sierra Gold Tequila", "Northeast"));
    ...
    {
        JsonElement result = Parse(_db.GenerateForecast(brand));
    ...
    {
        JsonElement result = Parse(_db.GetSeasonalityFactors(category));
    ...
    {
        JsonElement result = Parse(_db.GetSeasonalityFactors("Spirits"));

        result.TryGetProperty("error", out _).Should().BeFalse();
        JsonElement factors = result.GetProperty("factors");

        foreach (JsonElement factor in factors.EnumerateArray())
        {
            double multiplier = factor.GetProperty("multiplier").GetDouble();
    ...
    {
        JsonElement result = Parse(_db.GetSeasonalityFactors(null));
    ...
    {
        JsonElement result = Parse(_db.GetSeasonalityFactors("Interstellar Travel"));
    ...
    public void GetSeasonalityFactors_FactorsHaveImpactClassification()
    {
        ...
        string[] validImpacts = ["strong_boost", "moderate_boost", "baseline", "moderate_decline", "significant_decline"];

        foreach (JsonElement factor in factors.EnumerateArray())
        {
            string? impact = factor.GetProperty("impact").GetString();
    ...
    {
        JsonElement result = Parse(_db.IdentifyDemandRisks("Sierra Gold Tequila"));
    ...
    {
        JsonElement result = Parse(_db.IdentifyDemandRisks(null));
        ...
        {
            string? severity = risk.GetProperty("severity").GetString();
    ...
    public void IdentifyDemandRisks_ReturnsArrayWhenNoRisks()
    {
        ...
        JsonElement result = Parse(_db.IdentifyDemandRisks("Sierra Gold Tequila", "Northeast"));
    ...
    public void IdentifyDemandRisks_RiskSummaryHasCategories()
    {
        ...
        JsonElement summary = result.GetProperty("risk_summary");
