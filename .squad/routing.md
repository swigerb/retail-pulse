...
|-----------|----------|----------|
| Architecture & scope | Kroger | Aspire orchestration, solution structure, system design, trade-offs, tenant config |
...
| Label | Action | Who |
|-------|--------|-----|
| `squad` | Triage: analyze issue, assign `squad:{member}` label | Kroger |
