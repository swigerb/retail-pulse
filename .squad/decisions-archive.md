...
## Archive — 2026-06-03T15:13:12Z

Entries archived from decisions.md (size 80,111 bytes; policy: archive when >= 51,200 bytes).
...
## Archive — 2026-08-11T08-08-17Z

Entries archived from decisions.md (size 37,838 bytes; policy: archive entries older than 30 days).
